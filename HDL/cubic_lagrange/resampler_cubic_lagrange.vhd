----------------------------------------------------------------------------------
-- Module Name: resampler_cubic_lagrange
...
--   - Fully pipelined 4-Point Lagrange cubic core
----------------------------------------------------------------------------------
...
entity resampler_cubic_lagrange is
    port (
        clk        : in  std_logic;
        rst_n      : in  std_logic;
...
end entity resampler_cubic_lagrange;

architecture rtl of resampler_cubic_lagrange is
    ...
    component cubic_lagrange_core is
        port (
            clk       : in  std_logic;
            rst_n     : in  std_logic;
            in_valid  : in  std_logic;
